...
HD_PWD='/home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/IP/Commandes/Commandes.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Commandes_v1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Commandes_v1_0.tcl
