...
#
# Generated by Vivado on Wed Sep 23 16:32:43 CEST 2026
...
compile()
{
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../PLL_2.gen/sources_1/bd/design_1/ipshared/d0f7" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../PLL_2.gen/sources_1/bd/design_1/ipshared/d0f7" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/IP/PLL_2/PLL_2.cache/compile_simlib/vcs"
  fi
