...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_ports clk_out] [get_bd_pins clk_wiz/clk_out1]
  connect_bd_net -net clk_wiz_0_locked [get_bd_ports locked] [get_bd_pins clk_wiz/locked]
