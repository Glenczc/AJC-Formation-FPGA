...
HD_PWD='/home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/IP/AXI_Select/AXI_Select.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_Select.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI_Select.tcl
