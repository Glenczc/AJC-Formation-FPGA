...
HD_PWD='/home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/IP/TPG/TPG.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TPG.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TPG.tcl
