...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ControleurVGA is
  ...
  signal v_cntr_reg_reg : STD_LOGIC_VECTOR ( 5 downto 0 );
  signal v_sync_reg : STD_LOGIC;
  signal v_sync_reg_i_1_n_0 : STD_LOGIC;
  attribute SOFT_HLUTNM : string;
  attribute SOFT_HLUTNM of H_sync_flag_i_2 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of V_sync_flag_i_1 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \h_cntr_reg[1]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \h_cntr_reg[2]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \h_cntr_reg[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \h_cntr_reg[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \h_cntr_reg[5]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \h_cntr_reg[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \h_cntr_reg[7]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \h_cntr_reg[7]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of h_sync_reg_i_1 : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of ready_INST_0 : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \v_cntr_reg[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \v_cntr_reg[4]_i_1\ : label is "soft_lutpair2";
begin
...
H_sync_flag_i_2: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\h_cntr_reg[0]_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\h_cntr_reg[5]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\h_cntr_reg[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
h_sync_reg_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FEAAAAAB"
    )
        port map (
...
\v_cntr_reg[4]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"6AAAAAAA"
    )
        port map (
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute x_interface_parameter of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_RESET reset, FREQ_HZ 125000000, FREQ_TOLERANCE_HZ 0, PHASE 0.000, CLK_DOMAIN design_1_clk_100MHz, INSERT_VIP 0";
