...
-- Date        : Thu Sep 10 10:22:03 2026
-- Host        : glen-HP-ZBook-15u-G3 running 64-bit Ubuntu 24.04.4 LTS
-- Command     : write_vhdl -force -mode funcsim -rename_top decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix -prefix
--               decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ design_1_TPG_0_2_sim_netlist.vhdl
...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_TPG is
  ...
  signal \ltOp__1_carry__0_i_1_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry__0_i_2_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry__0_n_3\ : STD_LOGIC;
  signal \ltOp__1_carry_i_1_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry_i_2_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry_i_3_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry_i_4_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry_i_5_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry_i_6_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry_n_0\ : STD_LOGIC;
  signal \ltOp__1_carry_n_1\ : STD_LOGIC;
  signal \ltOp__1_carry_n_2\ : STD_LOGIC;
  ...
  signal \NLW_ltOp__1_carry__0_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 2 );
  signal \NLW_ltOp__1_carry__0_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_ltOp__7_carry_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 to 3 );
  ...
  attribute SOFT_HLUTNM of box_x_dir_i_5 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of box_x_dir_i_6 : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of box_x_dir_i_7 : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of box_y_dir_i_4 : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of box_y_dir_i_6 : label is "soft_lutpair1";
  ...
  attribute COMPARATOR_THRESHOLD of \ltOp__1_carry__0\ : label is 11;
...
\ltOp__1_carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \ltOp__1_carry_n_0\,
      CO(2) => \ltOp__1_carry_n_1\,
      CO(1) => \ltOp__1_carry_n_2\,
      CO(0) => \ltOp__1_carry_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \ltOp__1_carry_i_1_n_0\,
      DI(0) => \ltOp__1_carry_i_2_n_0\,
      O(3 downto 0) => \NLW_ltOp__1_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => \ltOp__1_carry_i_3_n_0\,
      S(2) => \ltOp__1_carry_i_4_n_0\,
      S(1) => \ltOp__1_carry_i_5_n_0\,
      S(0) => \ltOp__1_carry_i_6_n_0\
    );
\ltOp__1_carry__0\: unisim.vcomponents.CARRY4
     port map (
      CI => \ltOp__1_carry_n_0\,
      CO(3 downto 2) => \NLW_ltOp__1_carry__0_CO_UNCONNECTED\(3 downto 2),
      CO(1) => ltOp11_in,
      CO(0) => \ltOp__1_carry__0_n_3\,
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
      O(3 downto 0) => \NLW_ltOp__1_carry__0_O_UNCONNECTED\(3 downto 0),
      S(3 downto 2) => B"00",
      S(1) => \ltOp__1_carry__0_i_1_n_0\,
      S(0) => \ltOp__1_carry__0_i_2_n_0\
    );
\ltOp__1_carry__0_i_1\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      ...
      O => \ltOp__1_carry__0_i_1_n_0\
    );
\ltOp__1_carry__0_i_2\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\ltOp__1_carry_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ltOp__1_carry_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
      I0 => v_cntr_reg_reg(4),
      I1 => v_cntr_reg_reg(5),
      O => \ltOp__1_carry_i_4_n_0\
    );
\ltOp__1_carry_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => v_cntr_reg_reg(3),
      I1 => v_cntr_reg_reg(2),
      O => \ltOp__1_carry_i_5_n_0\
    );
\ltOp__1_carry_i_6\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
      I0 => v_cntr_reg_reg(1),
      I1 => v_cntr_reg_reg(0),
      O => \ltOp__1_carry_i_6_n_0\
    );
\ltOp__7_carry\: unisim.vcomponents.CARRY4
     port map (
      CI => '0',
      CO(3) => \NLW_ltOp__7_carry_CO_UNCONNECTED\(3),
      CO(2) => ltOp12_in,
      CO(1) => \ltOp__7_carry_n_2\,
      CO(0) => \ltOp__7_carry_n_3\,
      CYINIT => '0',
      DI(3 downto 2) => B"00",
      DI(1) => \ltOp__7_carry_i_1_n_0\,
      DI(0) => \ltOp__7_carry_i_2_n_0\,
      O(3 downto 0) => \NLW_ltOp__7_carry_O_UNCONNECTED\(3 downto 0),
      S(3) => '0',
      S(2) => \ltOp__7_carry_i_3_n_0\,
      S(1) => \ltOp__7_carry_i_4_n_0\,
      S(0) => \ltOp__7_carry_i_5_n_0\
    );
\ltOp__7_carry_i_1\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ltOp__7_carry_i_2\: unisim.vcomponents.LUT1
    generic map(
      INIT => X"1"
    )
        port map (
...
\ltOp__7_carry_i_3\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"1"
    )
        port map (
...
\ltOp__7_carry_i_4\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
\ltOp__7_carry_i_5\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"2"
    )
        port map (
...
entity decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix is
  ...
  attribute CHECK_LICENSE_TYPE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix : entity is "design_1_TPG_0_2,TPG,{}";
