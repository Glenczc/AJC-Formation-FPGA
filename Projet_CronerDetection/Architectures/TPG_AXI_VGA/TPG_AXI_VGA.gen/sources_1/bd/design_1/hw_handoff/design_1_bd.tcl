...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net AXI4_stream_Master_2_2_interface_axis [get_bd_intf_pins AXI4_stream_Master_2_2/interface_axis] [get_bd_intf_pins ControleurVGA_v3_0/interface_axis]

  # Create port connections
  connect_bd_net -net AXI4_stream_Master_2_2_fulln [get_bd_pins AXI4_stream_Master_2_2/fulln] [get_bd_pins TPG_0/start]
  ...
  connect_bd_net -net clk_wiz_0_clk_wiz_0_clk_out1 [get_bd_pins AXI4_stream_Master_2_2/clk] [get_bd_pins ControleurVGA_v3_0/clk] [get_bd_pins TPG_0/clk] [get_bd_pins clk_wiz_0_clk_wiz_0/clk_out1]
  connect_bd_net -net reset_2 [get_bd_ports reset] [get_bd_pins AXI4_stream_Master_2_2/reset] [get_bd_pins ControleurVGA_v3_0/reset] [get_bd_pins TPG_0/reset]
