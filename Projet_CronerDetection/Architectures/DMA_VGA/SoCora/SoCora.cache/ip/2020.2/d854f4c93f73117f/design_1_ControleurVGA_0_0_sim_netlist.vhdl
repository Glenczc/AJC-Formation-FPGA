...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ControleurVGA is
  ...
  signal H_sync_flag_reg_n_0 : STD_LOGIC;
  signal V_sync_flag : STD_LOGIC;
  signal V_sync_flag_i_1_n_0 : STD_LOGIC;
  signal V_sync_flag_i_2_n_0 : STD_LOGIC;
  signal \h_counter[4]_i_2_n_0\ : STD_LOGIC;
  signal \h_counter[7]_i_2_n_0\ : STD_LOGIC;
  signal \h_counter_max[4]_i_2_n_0\ : STD_LOGIC;
  signal \h_counter_max[9]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \h_counter[0]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \h_counter[1]_i_1\ : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \h_counter[2]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \h_counter[3]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \h_counter[4]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \h_counter[5]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \h_counter[6]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \h_counter[7]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \h_counter[7]_i_2\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \h_counter_max[0]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \h_counter_max[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \h_counter_max[2]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \h_counter_max[3]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \h_counter_max[6]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \h_counter_max[7]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \h_counter_max[9]_i_2\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of h_sync_reg_i_4 : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of h_sync_reg_i_5 : label is "soft_lutpair1";
...
begin
H_sync_flag_i_1: unisim.vcomponents.LUT6
    generic map(
      ...
      I4 => \h_counter_max[4]_i_2_n_0\,
      I5 => H_sync_flag_reg_n_0,
      O => H_sync_flag_i_1_n_0
    );
H_sync_flag_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
V_sync_flag_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"BBBAAAAA"
    )
        port map (
      I0 => V_end,
      I1 => H_end,
      I2 => \h_counter_max[4]_i_2_n_0\,
      I3 => V_sync_flag_i_2_n_0,
      I4 => V_sync_flag,
      O => V_sync_flag_i_1_n_0
    );
V_sync_flag_i_2: unisim.vcomponents.LUT6
    generic map(
...
V_sync_flag_reg: unisim.vcomponents.FDCE
    generic map(
      INIT => '0'
    )
        port map (
...
\h_counter[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2888"
    )
        port map (
...
\h_counter[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"28888888"
    )
        port map (
...
\h_counter[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\h_counter[4]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"FFFD"
    )
        port map (
...
\h_counter[5]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"F00B"
    )
        port map (
...
\h_counter[7]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"AA68"
    )
        port map (
...
\h_counter[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
\h_counter_max[1]_i_1\: unisim.vcomponents.LUT3
    generic map(
      INIT => X"28"
    )
        port map (
...
\h_counter_max[2]_i_1\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"2888"
    )
        port map (
...
\h_counter_max[3]_i_1\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"28888888"
    )
        port map (
...
\h_counter_max[4]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"2888888888888888"
    )
        port map (
...
\h_counter_max[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
...
\h_counter_max[9]_i_1\: unisim.vcomponents.LUT6
    generic map(
...
\h_counter_max[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
h_sync_reg_i_4: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
...
h_sync_reg_i_5: unisim.vcomponents.LUT4
    generic map(
      INIT => X"7FFF"
    )
        port map (
