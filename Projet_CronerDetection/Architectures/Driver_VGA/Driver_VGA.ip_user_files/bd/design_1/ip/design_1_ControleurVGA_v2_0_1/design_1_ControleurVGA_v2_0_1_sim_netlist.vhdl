...
-- Date        : Thu Sep 24 10:41:30 2026
-- Host        : glen-HP-ZBook-15u-G3 running 64-bit Ubuntu 24.04.5 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/Architectures/Driver_VGA/Driver_VGA.gen/sources_1/bd/design_1/ip/design_1_ControleurVGA_v2_0_1/design_1_ControleurVGA_v2_0_1_sim_netlist.vhdl
-- Design      : design_1_ControleurVGA_v2_0_1
...
entity design_1_ControleurVGA_v2_0_1_ControleurVGA is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_ControleurVGA_v2_0_1_ControleurVGA : entity is "ControleurVGA";
end design_1_ControleurVGA_v2_0_1_ControleurVGA;

architecture STRUCTURE of design_1_ControleurVGA_v2_0_1_ControleurVGA is
  ...
  signal \h_counter[7]_i_3_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[0]_i_3\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \FSM_sequential_current_state[1]_i_1\ : label is "soft_lutpair0";
  attribute FSM_ENCODED_STATES : string;
  attribute FSM_ENCODED_STATES of \FSM_sequential_current_state_reg[0]\ : label is "fin_ligne:11,fin_im1:00,fin_im2:01,reception:10";
  attribute FSM_ENCODED_STATES of \FSM_sequential_current_state_reg[1]\ : label is "fin_ligne:11,fin_im1:00,fin_im2:01,reception:10";
  ...
  attribute SOFT_HLUTNM of \h_counter[3]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \h_counter[4]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \h_counter[5]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \h_counter[6]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \h_counter[7]_i_2\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \h_counter[7]_i_3\ : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \h_counter_max[4]_i_1\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of \h_counter_max[9]_i_3\ : label is "soft_lutpair1";
...
\h_counter[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      ...
      I0 => h_counter_reg(6),
      I1 => h_counter_reg(5),
      I2 => \h_counter[7]_i_3_n_0\,
      I3 => h_counter_reg(4),
      I4 => h_counter_reg(7),
      O => \p_0_in__1\(7)
    );
\h_counter[7]_i_3\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8000"
    )
        port map (
...
\h_counter_max[9]_i_2\: unisim.vcomponents.LUT6
    generic map(
      ...
      I2 => \h_counter_max[9]_i_3_n_0\,
      I3 => h_counter_max_reg(7),
      I4 => h_counter_max_reg(8),
      I5 => h_counter_max_reg(9),
      O => \p_0_in__0\(9)
    );
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ControleurVGA_v2_0_1 is
  port (
    clk : in STD_LOGIC;
    reset : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_ControleurVGA_v2_0_1 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_ControleurVGA_v2_0_1 : entity is "design_1_ControleurVGA_v2_0_1,ControleurVGA,{}";
  attribute downgradeipidentifiedwarnings : string;
  attribute downgradeipidentifiedwarnings of design_1_ControleurVGA_v2_0_1 : entity is "yes";
  attribute ip_definition_source : string;
  attribute ip_definition_source of design_1_ControleurVGA_v2_0_1 : entity is "package_project";
  attribute x_core_info : string;
  attribute x_core_info of design_1_ControleurVGA_v2_0_1 : entity is "ControleurVGA,Vivado 2020.2";
end design_1_ControleurVGA_v2_0_1;

architecture STRUCTURE of design_1_ControleurVGA_v2_0_1 is
...
begin
U0: entity work.design_1_ControleurVGA_v2_0_1_ControleurVGA
     port map (
      H_end => H_end,
