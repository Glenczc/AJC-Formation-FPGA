...
proc create_root_design { parentCell } {
  ...
  # Create instance: image_in, and set properties
  set image_in [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 image_in ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net DMA24bUnit_mm2s_0_STR_video_out [get_bd_intf_pins AXI_Select_0/AXI_B] [get_bd_intf_pins DMA24bUnit_mm2s_0/STR_video_out]
