...
HD_PWD='/home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/IP/ControleurVGA_v2/ControleurVGA_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ControleurVGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ControleurVGA.tcl
