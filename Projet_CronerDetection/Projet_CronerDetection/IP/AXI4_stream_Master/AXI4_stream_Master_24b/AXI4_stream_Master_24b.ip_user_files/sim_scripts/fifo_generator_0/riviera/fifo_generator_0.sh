...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/IP/AXI4_stream_Master/AXI4_stream_Master_24b/AXI4_stream_Master_24b.cache/compile_simlib/riviera"
  fi
