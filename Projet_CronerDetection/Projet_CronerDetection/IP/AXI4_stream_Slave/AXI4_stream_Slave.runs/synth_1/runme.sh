...
HD_PWD='/home/glen/Documents/AJC-Expleo/Travaux/Projet_CronerDetection/IP/AXI4_stream_Slave/AXI4_stream_Slave.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI4_stream_Slave.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source AXI4_stream_Slave.tcl
