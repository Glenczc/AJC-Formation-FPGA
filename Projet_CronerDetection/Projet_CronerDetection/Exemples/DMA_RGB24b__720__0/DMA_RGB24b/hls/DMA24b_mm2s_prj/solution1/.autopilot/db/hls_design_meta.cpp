...
const Port_Property HLS_Design_Meta::port_props[]={
	...
	Port_Property("STR_video_out_TDATA", 24, hls_out, 1, "axis", "out_data", 1),
	Port_Property("STR_video_out_TVALID", 1, hls_out, 5, "axis", "out_vld", 1),
	Port_Property("STR_video_out_TREADY", 1, hls_in, 5, "axis", "out_acc", 1),
	Port_Property("STR_video_out_TKEEP", 3, hls_out, 2, "axis", "out_data", 1),
	Port_Property("STR_video_out_TSTRB", 3, hls_out, 3, "axis", "out_data", 1),
	Port_Property("STR_video_out_TUSER", 1, hls_out, 4, "axis", "out_data", 1),
	Port_Property("STR_video_out_TLAST", 1, hls_out, 5, "axis", "out_data", 1),
	Port_Property("image_w", 12, hls_in, 6, "ap_none", "in_data", 1),
	Port_Property("image_h", 12, hls_in, 7, "ap_none", "in_data", 1),
	Port_Property("image_in", 64, hls_in, 8, "ap_none", "in_data", 1),
};
const char* HLS_Design_Meta::dut_name = "DMA24bUnit_mm2s";
