...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.FREQ_HZ {100000000} \
   CONFIG.CLK_DOMAIN {clk_wiz} \
 ] [get_bd_pins /ControleurVGA_0/clk]

  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_HIGH} \
 ] [get_bd_pins /ControleurVGA_0/reset]
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_SDIO_PERIPHERAL_FREQMHZ {100} \
  ...
  # Create instance: slave1_ready, and set properties
  set slave1_ready [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 slave1_ready ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {1} \
  ...
  connect_bd_net -net AXI4_stream_Slave_2_data_out [get_bd_pins AXI4_stream_Slave_2/data_out] [get_bd_pins ControleurVGA_0/pixel]
  connect_bd_net -net AXI4_stream_Slave_2_last [get_bd_pins AXI4_stream_Slave_2/last] [get_bd_pins ControleurVGA_0/H_end]
  connect_bd_net -net AXI4_stream_Slave_2_user [get_bd_pins AXI4_stream_Slave_2/user] [get_bd_pins ControleurVGA_0/V_end]
  connect_bd_net -net AXI4_stream_Slave_2_valid [get_bd_pins AXI4_stream_Slave_2/valid] [get_bd_pins ControleurVGA_0/valid]
  ...
  connect_bd_net -net ControleurVGA_0_ready [get_bd_pins AXI4_stream_Slave_2/ready] [get_bd_pins ControleurVGA_0/ready]
  connect_bd_net -net ap_rst_n_0_1 [get_bd_ports reset] [get_bd_pins AXI4_stream_Master_2_0/reset] [get_bd_pins AXI4_stream_Slave_1/reset] [get_bd_pins AXI4_stream_Slave_2/reset] [get_bd_pins ControleurVGA_0/reset] [get_bd_pins reset_not/Op1]
  connect_bd_net -net clk_wiz_0_clk_wiz_0_clk_out1 [get_bd_pins AXI4_stream_Master_2_0/clk] [get_bd_pins AXI4_stream_Slave_1/clk] [get_bd_pins AXI4_stream_Slave_2/clk] [get_bd_pins ControleurVGA_0/clk] [get_bd_pins DMA24bUnit_mm2s_0/ap_clk] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins clk_wiz_0_clk_wiz_0/clk_out1]
  ...
  connect_bd_net -net slave1_ready_dout [get_bd_pins AXI4_stream_Slave_1/ready] [get_bd_pins slave1_ready/dout]
