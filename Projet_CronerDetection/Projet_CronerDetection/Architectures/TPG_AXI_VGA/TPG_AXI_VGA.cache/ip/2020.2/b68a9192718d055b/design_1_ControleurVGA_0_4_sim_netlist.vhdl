...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ControleurVGA is
  ...
  attribute SOFT_HLUTNM of V_sync_flag_i_1 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \h_counter[1]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \h_counter[2]_i_1\ : label is "soft_lutpair8";
  attribute SOFT_HLUTNM of \h_counter[3]_i_1\ : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of \h_counter[4]_i_1\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \h_counter[5]_i_1\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \h_counter[7]_i_2\ : label is "soft_lutpair6";
  attribute SOFT_HLUTNM of \h_counter[7]_i_3\ : label is "soft_lutpair1";
  attribute SOFT_HLUTNM of \h_counter_max[1]_i_1\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \h_counter_max[2]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \h_counter_max[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \h_counter_max[4]_i_1\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of \h_counter_max[6]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \h_counter_max[7]_i_1\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \h_counter_max[9]_i_2\ : label is "soft_lutpair0";
  attribute SOFT_HLUTNM of h_sync_reg_i_4 : label is "soft_lutpair5";
  attribute SOFT_HLUTNM of h_sync_reg_i_5 : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of ready_INST_0 : label is "soft_lutpair9";
  attribute SOFT_HLUTNM of \v_counter[1]_i_1\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \v_counter[4]_i_1\ : label is "soft_lutpair2";
begin
...
V_sync_flag_i_1: unisim.vcomponents.LUT3
    generic map(
      INIT => X"BA"
    )
        port map (
...
\h_counter[7]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BE40"
        ...
        port map (
      I0 => \h_counter[7]_i_3_n_0\,
      I1 => h_counter_reg(6),
      I2 => h_counter_reg(5),
      I3 => h_counter_reg(7),
      O => \p_0_in__1\(7)
    );
\h_counter[7]_i_3\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"7FFFFFFF"
    )
        port map (
...
h_sync_reg_i_5: unisim.vcomponents.LUT3
    generic map(
      INIT => X"7F"
    )
        port map (
