...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ControleurVGA is
  ...
  attribute SOFT_HLUTNM of V_sync_flag_i_1 : label is "soft_lutpair8";
  ...
  attribute SOFT_HLUTNM of \h_counter_max[0]_i_1\ : label is "soft_lutpair9";
  ...
  attribute SOFT_HLUTNM of ready_INST_0 : label is "soft_lutpair8";
...
begin
H_sync_flag_i_1: unisim.vcomponents.LUT5
    generic map(
      INIT => X"54554444"
    )
        port map (
...
V_sync_flag_i_1: unisim.vcomponents.LUT4
    generic map(
      INIT => X"BAAA"
    )
        port map (
