set moduleName DMA24b_mm2s_fetch_Pipeline_line_loop_burst_loop_beat_loop
set isTopModule 0
...
set cdfgNum 8
set C_modelName {DMA24b_mm2s_fetch_Pipeline_line_loop_burst_loop_beat_loop}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ bound4 int 22 regular  }
	{ mm_fifo int 128 regular {fifo 1 volatile }  }
	{ p_cast int 10 regular  }
	{ bound int 10 regular  }
	{ mm_buffer int 64 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "bound4", "interface" : "wire", "bitwidth" : 22, "direction" : "READONLY"} , 
 	{ "Name" : "mm_fifo", "interface" : "fifo", "bitwidth" : 128, "direction" : "WRITEONLY"} , 
 	{ "Name" : "p_cast", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "bound", "interface" : "wire", "bitwidth" : 10, "direction" : "READONLY"} , 
 	{ "Name" : "mm_buffer", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ m_axi_gmem_0_WDATA sc_out sc_lv 128 signal 5 } 
	{ m_axi_gmem_0_WSTRB sc_out sc_lv 16 signal 5 } 
	...
	{ m_axi_gmem_0_RDATA sc_in sc_lv 128 signal 5 } 
	{ m_axi_gmem_0_RLAST sc_in sc_logic 1 signal 5 } 
	{ m_axi_gmem_0_RID sc_in sc_lv 1 signal 5 } 
	{ m_axi_gmem_0_RFIFONUM sc_in sc_lv 11 signal 5 } 
	...
	{ mm_fifo_din sc_out sc_lv 128 signal 1 } 
	{ mm_fifo_full_n sc_in sc_logic 1 signal 1 } 
	{ mm_fifo_write sc_out sc_logic 1 signal 1 } 
	{ mm_fifo_num_data_valid sc_in sc_lv 9 signal 1 } 
	{ mm_fifo_fifo_cap sc_in sc_lv 9 signal 1 } 
	{ bound4 sc_in sc_lv 22 signal 0 } 
	{ p_cast sc_in sc_lv 10 signal 2 } 
	{ bound sc_in sc_lv 10 signal 3 } 
	{ mm_buffer sc_in sc_lv 64 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mm_fifo_din", "direction": "out", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "mm_fifo", "role": "din" }} , 
 	{ "name": "mm_fifo_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mm_fifo", "role": "full_n" }} , 
 	{ "name": "mm_fifo_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mm_fifo", "role": "write" }} , 
 	...
 	{ "name": "bound", "direction": "in", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "bound", "role": "default" }} , 
 	{ "name": "mm_buffer", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "mm_buffer", "role": "default" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "4", "Max" : "3112213"}
	, {"Name" : "Interval", "Min" : "4", "Max" : "3112213"}
]}
...
set Spec2ImplPortList { 
	...
	mm_fifo { ap_fifo {  { mm_fifo_din fifo_data_in 1 128 }  { mm_fifo_full_n fifo_status 0 1 }  { mm_fifo_write fifo_port_we 1 1 }  { mm_fifo_num_data_valid fifo_status_num_data_valid 0 9 }  { mm_fifo_fifo_cap fifo_update 0 9 } } }
	p_cast { ap_none {  { p_cast in_data 0 10 } } }
	bound { ap_none {  { bound in_data 0 10 } } }
	mm_buffer { ap_none {  { mm_buffer in_data 0 64 } } }
