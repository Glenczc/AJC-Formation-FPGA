...
set C_modelArgList {
	{ mm_fifo1 int 128 regular {fifo 0 volatile }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "mm_fifo1", "interface" : "fifo", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ mm_fifo1_dout sc_in sc_lv 128 signal 0 } 
	{ mm_fifo1_empty_n sc_in sc_logic 1 signal 0 } 
	{ mm_fifo1_read sc_out sc_logic 1 signal 0 } 
	{ STR_video_out_TDATA sc_out sc_lv 24 signal 1 } 
	{ STR_video_out_TVALID sc_out sc_logic 1 outvld 5 } 
	{ STR_video_out_TREADY sc_in sc_logic 1 outacc 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "mm_fifo1_dout", "direction": "in", "datatype": "sc_lv", "bitwidth":128, "type": "signal", "bundle":{"name": "mm_fifo1", "role": "dout" }} , 
 	{ "name": "mm_fifo1_empty_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mm_fifo1", "role": "empty_n" }} , 
 	{ "name": "mm_fifo1_read", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "mm_fifo1", "role": "read" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			{"Name" : "mm_fifo1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "0", "DependentChan" : "0", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mul_mul_12ns_8ns_20_4_1_U10", "Parent" : "0"}]}
...
set Spec2ImplPortList { 
	mm_fifo1 { ap_fifo {  { mm_fifo1_dout fifo_data 0 128 }  { mm_fifo1_empty_n fifo_status 0 1 }  { mm_fifo1_read fifo_update 1 1 } } }
	STR_video_out_V_data_V { axis {  { STR_video_out_TDATA out_data 1 24 }  { STR_video_out_TREADY out_acc 0 1 } } }
	...
	img_w { ap_fifo {  { img_w_dout fifo_data 0 12 }  { img_w_empty_n fifo_status 0 1 }  { img_w_read fifo_update 1 1 } } }
	img_h { ap_fifo {  { img_h_dout fifo_data 0 12 }  { img_h_empty_n fifo_status 0 1 }  { img_h_read fifo_update 1 1 } } }
}
