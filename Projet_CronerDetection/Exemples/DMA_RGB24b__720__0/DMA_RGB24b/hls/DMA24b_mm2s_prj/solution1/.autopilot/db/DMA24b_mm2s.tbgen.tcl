...
set C_modelArgMapList {[ 
	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 128, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ image_w_ap_vld sc_in sc_logic 1 invld 6 } 
	{ image_h_ap_vld sc_in sc_logic 1 invld 7 } 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1", "3", "5", "6", "7", "8"],
		...
		"OutputProcess" : [
			{"ID" : "3", "Name" : "DMA24b_mm2s_streamout_U0"}],
		"Port" : [
			...
			{"Name" : "STR_video_out_V_data_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "DMA24b_mm2s_streamout_U0", "Port" : "STR_video_out_V_data_V"}]},
			{"Name" : "STR_video_out_V_keep_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "DMA24b_mm2s_streamout_U0", "Port" : "STR_video_out_V_keep_V"}]},
			{"Name" : "STR_video_out_V_strb_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "DMA24b_mm2s_streamout_U0", "Port" : "STR_video_out_V_strb_V"}]},
			{"Name" : "STR_video_out_V_user_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "DMA24b_mm2s_streamout_U0", "Port" : "STR_video_out_V_user_V"}]},
			{"Name" : "STR_video_out_V_last_V", "Type" : "Axis", "Direction" : "O",
				"SubConnect" : [
					{"ID" : "3", "SubInstance" : "DMA24b_mm2s_streamout_U0", "Port" : "STR_video_out_V_last_V"}]},
			{"Name" : "image_w", "Type" : "None", "Direction" : "I"},
			{"Name" : "image_h", "Type" : "None", "Direction" : "I"},
			{"Name" : "BAR_image_in", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DMA24b_mm2s_fetch_U0", "Parent" : "0", "Child" : ["2"],
		...
		"Port" : [
			...
			{"Name" : "mm_fifo1", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "5", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
			...
			{"Name" : "img_w_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "6", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_w_out_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_h_out", "Type" : "Fifo", "Direction" : "O", "DependentProc" : "3", "DependentChan" : "7", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_h_out_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "2", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.DMA24b_mm2s_fetch_U0.mul_mul_11s_13ns_24_4_1_U1", "Parent" : "1"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.DMA24b_mm2s_streamout_U0", "Parent" : "0", "Child" : ["4"],
		...
		"Port" : [
			{"Name" : "mm_fifo1", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "5", "DependentChanDepth" : "256", "DependentChanType" : "0",
				"BlockSignal" : [
					{"Name" : "mm_fifo1_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "STR_video_out_V_data_V", "Type" : "Axis", "Direction" : "O",
				"BlockSignal" : [
			...
			{"Name" : "STR_video_out_V_user_V", "Type" : "Axis", "Direction" : "O"},
			{"Name" : "STR_video_out_V_last_V", "Type" : "Axis", "Direction" : "O"},
			{"Name" : "img_w", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "6", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_w_blk_n", "Type" : "RtlSignal"}]},
			{"Name" : "img_h", "Type" : "Fifo", "Direction" : "I", "DependentProc" : "1", "DependentChan" : "7", "DependentChanDepth" : "2", "DependentChanType" : "2",
				"BlockSignal" : [
					{"Name" : "img_h_blk_n", "Type" : "RtlSignal"}]}]},
	{"ID" : "4", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.DMA24b_mm2s_streamout_U0.mul_mul_12ns_8ns_20_4_1_U10", "Parent" : "3"},
	{"ID" : "5", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.mm_fifo_U", "Parent" : "0"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_w_c_U", "Parent" : "0"},
	{"ID" : "7", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.image_h_c_U", "Parent" : "0"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.start_for_DMA24b_mm2s_streamout_U0_U", "Parent" : "0"}]}
