...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DMA24bUnit_mm2s_fifo_w128_d256_A BINDTYPE {storage} TYPE {fifo} IMPL {memory} ALLOW_PRAGMA 1 INSTNAME {mm_fifo_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DMA24bUnit_mm2s_fifo_w12_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {image_w_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DMA24bUnit_mm2s_fifo_w12_d2_S BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {image_h_c_U}
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler DMA24bUnit_mm2s_start_for_DMA24b_mm2s_streamout_U0 BINDTYPE {storage} TYPE {fifo} IMPL {srl} ALLOW_PRAGMA 1 INSTNAME {start_for_DMA24b_mm2s_streamout_U0_U}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_image_w \
    op interface \
    ports { image_w { I 12 vector } image_w_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_image_h \
    op interface \
    ports { image_h { I 12 vector } image_h_ap_vld { I 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_BAR_image_in \
    op interface \
    ports { BAR_image_in { I 64 vector } BAR_image_in_ap_vld { I 1 bit } } \
} "
}
