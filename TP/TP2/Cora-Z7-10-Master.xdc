...
set_property -dict { PACKAGE_PIN L19   IOSTANDARD LVCMOS33 } [get_ports { end_counter_out }]; #IO_L9P_T1_DQS_AD3P_35 Sch=user_dio[1]
set_property -dict { PACKAGE_PIN M19   IOSTANDARD LVCMOS33 } [get_ports { resetn }]; #IO_L7P_T1_AD2P_35 Sch=user_dio[2]
