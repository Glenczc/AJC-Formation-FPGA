...
--appuis du bouton 0
	    ...
	    -- la commande ne prends effet qu'au clignotement suivant
		wait for threshold*period;
		wait for threshold*period;
...
-- on teste maintenant l'envoi de plusieurs commandes succesives
...
-- on se replace au début d'un cycle de clignotement
		wait for 3*period;
		wait for threshold*period;

-- la led verte clignote (commande 1)
...
-- la led verte clignote (commande 2)
...
-- la led bleue clignote (commande 3)
...
-- la led bleue clignote (commande 4)
...
-- la led verte clignote (commande 5)
...
-- la led bleue clignote (commande 6)
